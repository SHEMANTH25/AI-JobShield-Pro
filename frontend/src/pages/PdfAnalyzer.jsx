...
function PdfAnalyzer() {
  ...
  const analyzePDF = async () => {
    ...
    try {
      ...
      toast.error("Unable to analyze PDF.");
  ...
  return (
    <div className="container py-5">
      ...
      <h2 className="mb-3">PDF Job Analyzer</h2>

      <p className="text-muted mb-4">
        Upload a recruitment PDF and let AI JobShield Pro detect
        ...
        <div className="card shadow mt-5 p-4">
          ...
          <div className="text-end">
            ...
            <button
              ...
              onClick={() =>
                downloadReport(result, "PDF Analysis")
              }
            >
              📄 Download Report
            </button>
